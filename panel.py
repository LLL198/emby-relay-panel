...
button{min-height:36px;padding:8px 12px;border:0;border-radius:9px;background:#2fae65;box-shadow:0 5px 14px rgba(47,174,101,.17);color:#fff;font:inherit;font-size:12px;font-weight:750;cursor:pointer;transition:.15s transform,.15s filter}button:hover{transform:translateY(-1px);filter:brightness(.97)}button.danger{background:#d84a5b;box-shadow:0 5px 14px rgba(216,74,91,.14);color:#fff}button.secondary,button.copy-value{background:#667388;box-shadow:none}form.inline{display:inline-flex;margin:2px 3px 2px 0}.copy-control{display:flex;align-items:center;gap:7px}.copy-control button{flex:0 0 auto}.compact{display:flex;flex-wrap:wrap;align-items:flex-end;gap:9px;margin-top:10px;padding:12px;border-radius:11px;background:#f7f9fc}.compact label{min-width:130px;flex:1}.user-actions,.invite-actions{display:flex;align-items:center;flex-wrap:wrap;gap:6px}.user-actions form,.invite-actions form{margin:0}.user-actions button,.invite-actions button{min-height:32px;padding:6px 9px;font-size:11px}.row-editor{display:flex;align-items:flex-end;flex-wrap:wrap;gap:8px;margin-top:8px;padding:10px;border:1px solid #e4e7ec;border-radius:9px;background:#fafafa}.row-editor[hidden]{display:none}.row-editor label{min-width:115px;flex:1}.row-editor input{height:34px;padding:6px 8px;font-size:11px}.row-editor .editor-actions{display:flex;gap:6px}.row-editor .editor-actions button{min-height:34px}.inline-delete{margin:6px 0 0}.inline-delete button{color:#fff}.invite-actions .tag{flex:0 0 auto}
