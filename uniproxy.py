...
.my-routes{margin-top:16px;padding:22px;border-radius:18px}.my-routes .section-line{margin-bottom:10px}.routes-scroll{overflow-x:auto;-webkit-overflow-scrolling:touch}.my-routes table{width:100%;min-width:820px;border-collapse:separate;border-spacing:0}.my-routes th,.my-routes td{padding:12px 9px;border-bottom:1px solid #edf0f4;text-align:left;vertical-align:top}.my-routes th{color:#8590a1;font-size:9px;font-weight:850;letter-spacing:.06em;text-transform:uppercase}.my-routes td{font-size:11px}.my-routes tbody tr:last-child td{border-bottom:0}.route-url{display:inline-block;max-width:260px;color:#3972bb;word-break:break-all}.route-state{display:inline-flex;padding:3px 7px;border-radius:999px;background:#eaf8f0;color:#208750;font-size:9px;font-weight:800}.route-state.off{background:#fff4e6;color:#b86c17}.route-state.error-state{background:#fff1f2;color:#be123c}.route-note-editor{margin-top:6px}.route-note-editor summary{color:#3972bb;font-size:10px;font-weight:700;cursor:pointer}.route-note-editor form{display:flex;align-items:end;gap:6px;margin-top:8px;padding:9px;border-radius:9px;background:#f7f9fc}.route-note-editor label{min-width:160px}.route-note-editor input{height:34px;font-size:11px}.route-note-editor button,button.delete-route{min-height:32px;padding:6px 9px;font-size:10px}button.delete-route{background:#fff1f2;box-shadow:none;color:#c43c50}.route-error{display:inline-block;margin-top:5px;color:#c43c50;font-size:10px}
...
.result{border-color:#e4e4e7;background:#fafafa}.route-state{background:#f4f4f5;color:#3f3f46}.route-state.off,.route-state.error-state{background:#f4f4f5;color:#71717a}.route-url{color:#18181b}.my-routes th{color:#71717a}.my-routes td{border-bottom-color:#f4f4f5}.route-note-editor form{background:#fafafa}.route-note-editor summary{color:#3f3f46}button.delete-route{border:1px solid #fecaca;background:#fef2f2;color:#b91c1c}
...
async def generator_response(request: web.Request):
    ...
    for route in panel.user_routes(int(user["id"])):
        ...
        route_rows.append(
            ...
            f"<td>{html.escape(route['node_name'])}</td><td>{note_display}{note_editor}</td><td><span class='route-state {state_class}'>{state}</span>{error}</td><td><form method='post' action='/my/routes/{route['id']}/delete'>"
